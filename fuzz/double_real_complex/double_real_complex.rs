...
fuzz_target!(|data: Target| {
    ...
    let executor_forward = Zaft::make_r2c_fft_f64(data.size as usize).unwrap();
    let executor_backwards = Zaft::make_c2r_fft_f64(data.size as usize).unwrap();
